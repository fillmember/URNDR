...
var WACOM = document.getElementById('Wacom').penAPI || {pressure:1};
...
// OBJECTS
//
var STYLE, PEN, MODULES, STROKES, HUD, CANVAS, CONTEXT;
...
function clear(a) {
    if (a === 1) { CONTEXT.clearRect(0,0,CANVAS.width,CANVAS.height)
    } else {
        CONTEXT.save();
