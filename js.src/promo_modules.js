...
auto_rotation : function(){
    ...
    module.interval = 33.33;
    module.setConfiguration({
        rotate_speed: - Math.PI / 120,
        // exp:
        // 360 deg = PI * 2 / (fps = 30 * duration = 8 sec = 240 frames).
        counter: 0,
        change_radius: false,
        radius_speed: 0.02
    })
    module.setFunction(function(strokes){
        ...
        // 240 frames
        // f000 sin(0) = 0
        // f030 sin(Math.PI / 2) = 1
        // f060 sin(Math.PI) = 0
        // f090 sin(Math.PI / -2) = -1
        U3.rig.target_pitch = Math.sin( m.counter ) * 2;

        m.counter += 0.01666667;
    ...
    module.listener = function( evt ) {
        ...
        if (meta) {
            ...
            U3.rig.target_theta = 0;
            U3.rig.target_pitch = 0;
            module.settings.counter = 0;
        }
